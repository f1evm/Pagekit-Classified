<?php $view->script('ad-edit', 'classified:app/bundle/ad-edit.js', ['vue', 'editor', 'uikit']) ?>
...
<form id="ad" class="uk-form" v-validator="form" @submit.prevent="save | valid" v-cloak>
    ...
    <div class="uk-margin uk-flex uk-flex-space-between uk-flex-wrap" data-uk-margin>
        ...
        <div data-uk-margin>
            ...
            <a class="uk-button uk-margin-small-right" :href="$url.route('admin/classified/ad')">{{ ad.id ? 'Close' : 'Cancel' | trans }}</a>
